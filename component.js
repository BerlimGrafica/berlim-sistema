...
function Icon({ name, className = "w-4 h-4" }) {
    ...
    if (name === 'truck') return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="15" height="8" x="1" y="8" rx="1" ry="1"/><path d="M16 8h2.5a2 2 0 0 1 1.95 1.57l.5 3.43H16V8Z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="16.5" cy="18.5" r="2.5"/></svg>;
...
function CustomDatePicker({ value, onChange, placeholder, disabled, className }) {
    ...
    return (
        <div className="relative">
            ...
            {isOpen && (
                <div className="absolute top-full left-0 mt-2 z-[100] bg-white dark:bg-darkCard border border-gray-200 dark:border-darkBorder rounded-lg shadow-2xl p-4 w-72">
                    <div className="fixed inset-0 z-[-1]" onClick={(e) => { e.stopPropagation(); setIsOpen(false); }}></div>
...
// ==== COMPONENTE DE DROPDOWN CUSTOMIZADO (ESTILO MODAL) ====
