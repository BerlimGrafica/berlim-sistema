...
abaAtual === 'baixa' && (
                    <main className="flex-1 p-6 lg:p-10 max-w-[1400px] mx-auto w-full fade-in">
                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-4 mb-6 border-b border-gray-100 dark:border-darkBorder pb-6">
                            <div>
                                <h1 className="text-3xl font-semibold dark:text-white tracking-tight">HistÃ³rico de Notas</h1>
                                <p className="text-[13px] text-gray-500 dark:text-[#888888] mt-1">Busque ordens e filtre por perÃ­odo.</p>
                            </div>
                            <div className="flex flex-wrap items-end gap-3 w-full lg:w-auto">
                                ...
                                <div className="flex flex-col w-36">
                                    ...
                                    <CustomDatePicker value={dataFiltroInicio} onChange={setDataFiltroInicio} placeholder="InÃ­cio" className="bg-white dark:bg-darkCard border border-gray-200 dark:border-darkBorder rounded-md px-3 py-2 text-[13px] outline-none hover:border-brand transition" />
                                </div>
                                <div className="flex flex-col w-36">
                                    <span className="text-[10px] font-semibold text-gray-500 dark:text-[#888888] uppercase mb-1">AtÃ©:</span>
