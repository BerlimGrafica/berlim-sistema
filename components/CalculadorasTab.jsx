        ...
        <>
            { (
                    <div className="bg-[#EDEFF0] dark:bg-darkBg border-b border-gray-200 dark:border-darkBorder px-6 flex gap-6 z-20 overflow-x-auto no-scrollbar-style sticky top-[112px]">
                        ...
                        <button onClick={() => setCalculadoraAtiva('adçõesivo')} className={`py-3 text-[13px] font-semibold border-b-[3px] transition whitçõespace-nowrap flex items-center gap-2 ${calculadoraAtiva === 'adçõesivo' ? 'border-brand text-brand' : 'border-transparent text-gray-500 hover:text-gray-900 dark:text-[#888888] dark:hover:text-white'}`}><Icon name="grid" className="w-4 h-4" /> Adçõesivos (Vinil)</button>
