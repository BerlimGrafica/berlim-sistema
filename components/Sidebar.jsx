...
export default function Sidebar() {
    const { setModalAlertasAberto, modalAlertasAberto, alertasNaoLidos, setAlertasNaoLidos, setAbaAtual, pedidos, toggleDarkMode, darkMode, usuario, setUsuario, abaAtual } = useAppContext();

    return (
        <>
            <header className="sticky top-0 z-40 bg-white dark:bg-darkBg px-6 h-[64px] flex justify-between items-center">
                    <div className="flex items-center">
                        <img src="https://www.berlimgraficarapida.com.br/wp-content/uploads/elementor/thumbs/logosite-rm0erpiqj90gcf7ff4jp8ujys78opflob1b9vn5jjs.png" alt="Berlim GrÃ¡fica" className="h-8 object-contain" />
                    </div>
                    <div className="flex items-center gap-5">
                            ...
                            {modalAlertasAberto && (
                                <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-darkElevated border border-gray-200 dark:border-darkBorder rounded-lg shadow-lg py-2 z-50 fade-in">
                                    <div className="px-4 py-2 border-b border-gray-100 dark:border-darkBorder flex justify-between items-center">
                                        <h3 className="font-semibold text-[13px] dark:text-white">NotificaÃ§Ãµes</h3>
                                        {alertasNaoLidos.length > 0 && (
                                    ...
                                    <div className="max-h-60 overflow-y-auto custom-scrollbar">
                                        {alertasNaoLidos.length === 0 ? (
                                            <p className="px-4 py-4 text-[11px] text-gray-500 text-center">Nenhuma nova notificaÃ§Ã£o.</p>
                                        ) : (
                        ...
                        {/* SEPARADOR VERTICAL DE ELEGÃ‚NCIA */}
                        <div className="hidden sm:block w-[1px] h-8 bg-gray-200 dark:border-darkBorder"></div>

                        {/* BLOCO DO USUÃRIO ATUALIZADO */}
