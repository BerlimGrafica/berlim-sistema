                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <Tooltip label="Novo Cliente">
                                    <button type="button" onClick={() => { setNovoCliente({ id: null, nome: '', telefone: '', email: '', observacoes: '', cliente_problema: false }); setModalClienteAberto(true); }} aria-label="Novo Cliente" className="shrink-0 self-stretch w-[38px] flex items-center justify-center bg-elevado border border-borda-forte rounded hover:bg-darkHover transition">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        {isAdmin && (
                                            <Tooltip label="Novo Produto">
                                                <button type="button" onClick={() => { setNovoProduto({ id: null, nome: '', texto_padrao: '', preco_base: '' }); setModalProdutoAberto(true); }} aria-label="Novo Produto" className="shrink-0 self-stretch w-[38px] flex items-center justify-center bg-elevado border border-borda-forte rounded hover:bg-darkHover transition">
                                                    <Icon name="plus" className="w-4 h-4 text-brand" />
                                                </button>
                                            </Tooltip>
                                        )}
