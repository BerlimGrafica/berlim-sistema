                ...
                <div className="p-6 overflow-y-auto custom-scrollbar">
                    ...
                    <form id="formNota" onSubmit={salvarNotaFiscal} className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="text-[11px] text-gray-500 dark:text-[#A1A1AA] mb-1 block">Cliente (Identificação Interna)</label>
                            ...
                            <div>
                                <label className="text-[11px] text-gray-500 dark:text-[#A1A1AA] mb-1 block">Tipo de Nota</label>
                                <InlineDropdown
                            ...
                            <div className="col-span-2">
                                <label className="text-[11px] text-gray-500 dark:text-[#A1A1AA] mb-1 block">Serviço Feito</label>
                            ...
                            <div className={notaFiscalEmEdicao.tipo_nota === 'DANFE' ? '' : 'col-span-2'}>
                                <label className="text-[11px] text-gray-500 dark:text-[#A1A1AA] mb-1 block">Valor Pago (R$)</label>
                            ...
                            {notaFiscalEmEdicao.tipo_nota === 'DANFE' && (
                                <>
                                    <div>
                                        <label className="text-[11px] text-gray-500 dark:text-[#A1A1AA] mb-1 block">Forma de Pagamento</label>
                                    ...
                                    <div>
                                        <label className="text-[11px] text-gray-500 dark:text-[#A1A1AA] mb-1 block">Forma de Transporte</label>
                            ...
                            <div className="col-span-2">
                                <label className="text-[11px] text-gray-500 dark:text-[#A1A1AA] mb-1 block">Observações</label>
