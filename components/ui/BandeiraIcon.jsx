...
export function BandeiraIcon({ nome, className = "w-6 h-4" }) {
    ...
    switch (nome) {
        case 'Visa': return moldura('white', texto('VISA', '#1434CB'));
        case 'MasterCard': return moldura('white', <><circle cx="9.5" cy="8" r="5" fill="#EB001B" /><circle cx="14.5" cy="8" r="5" fill="#F79E1B" fillOpacity="0.85" /></>);
        case 'Elo': return moldura('white', texto('elo', '#1A1A1A'));
