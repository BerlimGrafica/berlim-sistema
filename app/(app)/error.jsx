    ...
    return (
        <main className="flex-1 flex items-center justify-center p-6 min-h-[60vh]">
            <div className="w-full max-w-md bg-superficie border border-borda rounded-xl p-8 shadow-sm flex flex-col items-center gap-4 text-center">
                ...
                <div>
                    <h2 className="text-lg font-black text-tinta tracking-tight">Algo deu errado nesta tela</h2>
                ...
                <div className="flex gap-3 mt-1">
                    <button type="button" onClick={() => unstable_retry()} className="bg-brand hover:bg-brandHover text-white px-4 py-2 text-corpo rounded-md font-semibold shadow-sm transition">
                        Tentar novamente
                    </button>
                    <a href="/" className="px-4 py-2 text-corpo rounded-md font-semibold border border-borda text-gray-600 dark:text-[#EDEDED] hover:bg-sutil transition">
                        Voltar ao início
                    </a>
                </div>
            </div>
