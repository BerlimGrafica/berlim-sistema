                ...
                <div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <Tooltip label="Copiar orçamentos de quantidades máximas">
                            <button onClick={copiarMaximos} aria-label="Copiar orçamentos de quantidades máximas" className="bg-brand text-white px-3 rounded flex items-center justify-center hover:bg-brand/90 transition shadow-sm h-full">
                                <Icon name="copy" className="w-4 h-4" />
                            </button>
                        </Tooltip>
                    </div>
